...
class BKITParser ( Parser ):
    ...
    class IterblockContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitIterblock" ):
                return visitor.visitIterblock(self)
            else:
                return visitor.visitChildren(self)
    ...
    class IterinitContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitIterinit" ):
                return visitor.visitIterinit(self)
            else:
                return visitor.visitChildren(self)
    ...
    class ItercondContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitItercond" ):
                return visitor.visitItercond(self)
            else:
                return visitor.visitChildren(self)
    ...
    class IterupdateContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitIterupdate" ):
                return visitor.visitIterupdate(self)
            else:
                return visitor.visitChildren(self)
